...
export default function AllGroups() {
  ...
  if (loading) {
    return (
      <div className="max-w-4xl mx-auto">
        <h1 className="text-2xl font-semibold text-gray-900 mb-4">All registered groups</h1>
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-2xl font-semibold text-gray-900 mb-1">All registered groups</h1>
      <p className="text-sm text-gray-500 mb-6">
        Groups approved by both admin and supervisor (active session).
      </p>
