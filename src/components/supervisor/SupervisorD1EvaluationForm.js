...
export default function SupervisorD1EvaluationForm() {
  const { user } = useAuth();
    ...
    return (
      <div className="max-w-4xl mx-auto mt-6">
        <div className="rounded-xl border border-amber-200 bg-amber-50 shadow-sm p-6 sm:p-8">
          <h1 className="text-xl font-semibold text-gray-900 mb-2">Supervisor D1 Evaluation Form</h1>
  ...
  return (
    <div className="max-w-4xl mx-auto mt-6">
      <div className="mb-4">
        ...
        <h1 className="text-2xl font-semibold text-gray-900 mb-1">Supervisor D1 Evaluation Form</h1>
        {(rollNo || fullName) && (
      ...
      <div className="rounded-xl border border-gray-200 bg-white shadow-sm p-6 sm:p-7">
        ...
        <div className="max-w-sm">
          <label htmlFor="marks20" className="block text-sm font-medium text-gray-700 mb-1">
            Marks (0–20)
          </label>
          <input
            id="marks20"p
