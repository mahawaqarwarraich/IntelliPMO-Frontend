...
export default function AdminD2EvaluationForm() {
  ...
  return (
    <div className="max-w-4xl mx-auto mt-6">
      <div className="mb-4">
        ...
        <h1 className="text-2xl font-semibold text-gray-900 mb-1">Admin D2 Evaluation Form</h1>
        {(rollNo || fullName) && (
      ...
      <div className="rounded-xl border border-gray-200 bg-white shadow-sm p-6 sm:p-7">
        ...
        <div className="max-w-sm">
          <label htmlFor="marks10d2" className="block text-sm font-medium text-gray-700 mb-1">
            Marks (0–10)
          </label>
          <input
            id="marks10d2"
